"""NPB 스탯 변환 — 원시 스탯 → 엔진용 BatterStats/PitcherStats.

KBO transform.py와 동일한 수식을 사용합니다.
...
from .extract import NPBBatterRaw, NPBPitcherRaw

logger = logging.getLogger(__name__)

# NPB GO/FO 추정: MLB 평균과 유사한 ground ball share
_DEFAULT_GB_SHARE = 0.44


def calculate_npb_league_stats(
    batters: list[NPBBatterRaw],
    season: int = 2025,
) -> LeagueStats:
    """NPB 전체 타자 데이터로 리그 평균 스탯 계산."""
